...
export const PACKAGE_INFO_CONFIG: PackageInfo[] = [
  {
  ...
  {
    library: 'react-snapshot',
    description_1: `is a zero-configuration static pre-renderer for React apps. Starting by targeting Create React App (because it's great)`,
