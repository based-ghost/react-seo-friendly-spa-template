...
export default class Home extends React.PureComponent<{}> {
    public render(): React.ReactNode {
        return (
            <div>
                <Helmet>
                    <title>{RoutesConfig.Home.meta.metaInfo.title}</title>
                    <meta name="og:title" content={RoutesConfig.Home.meta.metaInfo.title} />
                    <meta name="description" content={RoutesConfig.Home.meta.metaInfo.description} />
                    <meta name="og:description" content={RoutesConfig.Home.meta.metaInfo.description} />
                </Helmet>
    ...
    private renderHeroSection(): React.ReactNode {
        return (
                    ...
                    <div className='container has-text-centered'>
                        <div className='blog-title-img is-flex is-horizontal-center'>
                            <figure className='image is-154x154'>
                                <img src={require('../assets/img/react-logo-512px.png')} alt='logo' />
                            </figure>
                        </div>
    ...
    private renderContentSection(): React.ReactNode {
        return (
                ...
                <div className='columns'>
                    <div className='column'>
                        ...
                        <div className='content'>
                            <p>
                                <code>react-helmet</code> is a React plugin that allows you to manage your app's meta information, much like vue-meta does for Vue (vue-meta is based on react-helmet). However, instead of setting your data as props passed to a proprietary component, you simply export it as part of your component's data using the metaInfo property.
                            </p>
                            <p>
                    ...
                    <div className='column'>
                        ...
                        <div className='content'>
                            <p>
                                <code>react-ga</code> isn't just a wrapper of the Google Analytics API, but provides a solution to issues that most of the time you don't want to deal with or you not even know you have to deal with.
                            </p>
                            <p>
                                Features include: Automatic Google Analytics script loading; Automatic page tracking; Event batching; Opt-out from Google Analytics with promise support; Multiple domain ID tracking system; Vuex support; E-commerce API; Vue error exception tracking system; Debugging API.
                            </p>
                        </div>
                    </div>
                    <hr />
