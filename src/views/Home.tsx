      ...
      <div className='hero-body'>
        <div className='container has-text-centered'>
          ...
          <h2 className='subtitle'>
            <FontAwesomeIcon icon='check' /> TypeScript + TSX
          </h2>
          <h2 className='subtitle'>
            <FontAwesomeIcon icon='check' /> UI styled with Bulma CSS + SASS +
            Font Awesome 5 (svg-core)
          </h2>
          <h2 className='subtitle'>
            <FontAwesomeIcon icon='check' /> Configured as a (PWA) Progressive
            Web App
          </h2>
          <h2 className='subtitle'>
            <FontAwesomeIcon icon='check' /> Meta tags dynamically handled per
            route using <code>react-helmet</code>
          </h2>
          <h2 className='subtitle'>
            <FontAwesomeIcon icon='check' /> Google Analytics ready to go and
            easily configurable using <code>react-ga</code>
          </h2>
          <h2 className='subtitle blog-intro'>
            <FontAwesomeIcon icon='check' /> Configured to serve prerendered
            HTML using <code>react-snapshot</code>
          </h2>
        </div>
      </div>
    </section>
      ...
      <div className='columns'>
        <div className='column'>
          ...
          <div className='content'>
            ...
            periculis. Eos laudem vivendo ex. Ius alia essent audiam id, mea
            quando putant id, ex ponderum deterruisset eam. Simul possit
            ocurreret ne mea, eu illum petentium abhorreant has. Mea ad amet
            detracto mandamus, no putent mandamus sea. In pri minim quando,
            harum menandri intellegat vis at. No mei vulputate complectitur, per
            tamquam delectus complectitur ad. No alia corrumpit usu, cum no tota
            propriae deterruisset, mea an clita utroque democritum. Debet
            aliquam blandit ei nec. Usu malis suscipit delectus an, nec summo
            viris an, duis iriure civibus sed cu. Eos errem dictas id. Cu causae
            audiam forensibus mea, et audiam omnesque has. Nec et clita ancillae
            salutandi, in insolens assueverit eum. Cu sed zril adipisci. Per
            nisl diam ex. Ei vel meis inciderint, vel ei dictas sanctus
            explicari, nam id odio gubergren. Cum tollit quaestio ei, sit labore
            meliore accusamus ad, has an dolor utinam. Ne erat facete ius, ludus
